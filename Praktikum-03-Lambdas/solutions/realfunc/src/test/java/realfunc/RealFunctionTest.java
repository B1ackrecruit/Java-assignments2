...
import static realfunc.RealFunction.*;

public class RealFunctionTest {
  @Test
  public void realFunctionConstant(){
    RealFunction f = constant(3.21);
  ...
  public void realFunctionAddTo(){
    RealFunction f = sine(2.1,-1.5);
    RealFunction g = linear(-9.1,0.8);
  ...
  public void realFunctionMax(){
    RealFunction f = sine(2.1,-1.5);
    RealFunction g = sine(2.1,-1.5).approxDiff(1e-5);
    RealFunction h = linear(-9.1,0.8);
